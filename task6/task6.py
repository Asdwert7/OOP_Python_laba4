...
def color_to_hex(color_index: int) -> str:  # перевод индекса цвета в hex-строку
...
pic = Path("data/PIC.1").read_bytes()  # читаем байты из файла
